...
export default function Home() {
    ...
    // 🎨 สี Clay Variants สำหรับ 5 กล่องสถิติ
    const stats = [
    ...
    const detailedWaste = [
        ...
        { name: 'LDPE (ถุงพลาสติกฯ)', value: 290, color: 'bg-[#38bdf8]' },
        { name: 'กระดาษขาวดำ', value: 650, color: 'bg-[#f472b6]' },
        { name: 'กระดาษสีรวม', value: 410, color: 'bg-[#f59e0b]' },
        ...
        { name: 'เหล็กบาง', value: 180, color: 'bg-[#f472b6]' },
        { name: 'สังกะสี', value: 90, color: 'bg-[#f59e0b]' },
        { name: 'กระป๋องเบียร์', value: 340, color: 'bg-[#34d399]' },
        { name: 'กล่องเครื่องดื่ม UHT', value: 120, color: 'bg-[#7c3aed]' },
    ];
    ...
    return (
        <div className="w-full overflow-hidden">
            ...
            {/* ========================================= */}
            {/* SECTION 1: HERO & DASHBOARD (พื้นหลังสีม่วงอ่อน) */}
            {/* ========================================= */}
            <div className="bg-[#f0eeff] pt-8 md:pt-16 pb-16">
                <div className="max-w-7xl mx-auto px-6 md:px-8">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between min-h-[50vh] mb-20 fade-up">
                        ...
                        <div className="w-full md:w-1/2 flex flex-col items-start gap-6 z-10">
                            {/* เปลี่ยนจากอิโมจิ เป็นจุดสีม่วงกะพริบๆ (Pulsing Dot) ดูทันสมัยขึ้น */}
                            <div className="inline-flex items-center gap-2 bg-white/60 px-4 py-2 rounded-full shadow-[inset_0_2px_4px_rgba(255,255,255,1),_0_4px_10px_rgba(124,58,237,0.1)] backdrop-blur-sm">
                                ...
                                <span className="font-['Nunito'] font-bold text-[#1e1b4b] text-sm md:text-base border-l-2 border-[#1e1b4b]/10 pl-3">ระบบธนาคารขยะโรงเรียนเทศบาลอุโมงค์ 1</span>
                            </div>
                            ...
                            {/* ลบอิโมจิลูกโลกออก ปรับรูปประโยค */}
                            ...
                            {/* เปลี่ยน Button เป็น Link พร้อมนำทางไป /members */}
                            <Link to="/members" className="clay-btn-purple mt-4 w-max">
                                ดูรายชื่อสมาชิก <span className="ml-2 text-xl font-black">➔</span>
                            </Link>
                        </div>

                        {/* ฝั่งขวา: 3D Elements ล้วนด้วย Tailwind CSS */}
                        <div className="w-full md:w-1/2 flex justify-center mt-16 md:mt-0 relative perspective-[1000px]">

                            {/* เหรียญ 3D สีเหลืองอำพัน เปลี่ยนจากอิโมจิเป็นตัวอักษร ฿ */}
                            <div className="absolute right-10 -top-10 w-32 h-32 bg-[#f59e0b] rounded-full animate-float-3d-reverse flex items-center justify-center
                                shadow-[10px_15px_0px_#d97706,_inset_0_-8px_16px_rgba(0,0,0,0.2),_inset_0_8px_16px_rgba(255,255,255,0.5)] z-20">
                                <span className="text-5xl font-['Fredoka_One'] text-white drop-shadow-md">฿</span>
                            </div>

                            {/* กล่อง 3D สีม่วง หลัก เปลี่ยนจากอิโมจิเป็น Icon */}
                            <div className="w-56 h-64 md:w-72 md:h-80 bg-[#7c3aed] rounded-3xl animate-float-3d flex flex-col items-center justify-center gap-4
                                shadow-[15px_25px_0px_#5b21b6,_inset_0_-10px_20px_rgba(0,0,0,0.25),_inset_0_10px_20px_rgba(255,255,255,0.3)] border-4 border-[#8b5cf6]">
                            ...
                            {/* ดาวตกแต่ง เปลี่ยนเป็นลูกบอลสีฟ้าลอยๆ แทนอิโมจิ ✨ */}
                    ...
                    {/* 📊 ส่วนกล่องสถิติ 5 กล่อง */}
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6 mb-12">
                        {stats.map((stat, index) => (
                            <div
                                key={index}
                                className={`${stat.clayClass} p-5 md:p-6 flex flex-col fade-up hover-bouncy cursor-pointer`}
                        ...
                        <div className="lg:col-span-2 fade-up" style={{ animationDelay: '0.6s' }}>
                            <div className="clay-card p-6 md:p-8 relative h-full flex flex-col bg-white">
                                <div className="flex items-center gap-3 mb-6">
                                    {/* แท่งสีส้มด้านหน้า แทนอิโมจิถ้วยรางวัล */}
                                    ...
                                    {membersList.map((member, index) => (
                                        <div key={member.id} className="flex justify-between items-center p-4 bg-[#f8f9fa] rounded-2xl shadow-[inset_0_2px_4px_rgba(0,0,0,0.02)] hover:bg-[#f0eeff] transition-colors cursor-default">
                                            <div className="flex items-center gap-4">
                                                {/* เปลี่ยนมงกุฎเป็นตัวหนังสือ "1st" ขาดๆ เท่ๆ */}
                        ...
                        <div className="lg:col-span-1 fade-up" style={{ animationDelay: '0.7s' }}>
                            <div className="clay-card p-6 md:p-8 relative h-full flex flex-col items-center justify-start bg-white">
                                ...
                                <div className="flex items-center gap-3 w-full text-left mb-5">
                                    {/* แท่งสีชมพูด้านหน้า แทนอิโมจิกราฟ */}
                                ...
                                <div className="w-56 h-56 md:w-64 md:h-64 rounded-full clay-pie mb-6 relative flex-shrink-0"
                                    style={{
                                        background: `conic-gradient(#db2777 0% 30%, #f59e0b 30% 55%, #10b981 55% 75%, #7c3aed 75% 85%, #0ea5e9 85% 95%, #94a3b8 95% 100%)`
                                    }}>
                                ...
                                <div className="w-full flex flex-col gap-2 font-['Nunito'] font-bold text-sm md:text-base text-[#1e1b4b]">
                                    ...
                                    <div className="h-[2px] bg-[#f0eeff] mx-2 rounded-full shadow-[inset_0_1px_1px_rgba(0,0,0,0.02)]"></div>
                                    ...
                                    <div className="flex justify-between items-center px-3 py-1.5 rounded-xl hover:bg-[#f0eeff] transition-colors"><div className="flex items-center gap-3"><span className="w-4 h-4 bg-[#7c3aed] rounded-full shadow-inner"></span>อลูมิเนียม</div><span className="font-['Fredoka_One'] text-lg">10%</span></div>
                                    <div className="h-[2px] bg-[#f0eeff] mx-2 rounded-full shadow-[inset_0_1px_1px_rgba(0,0,0,0.02)]"></div>

                                    <div className="flex justify-between items-center px-3 py-1.5 rounded-xl hover:bg-[#f0eeff] transition-colors"><div className="flex items-center gap-3"><span className="w-4 h-4 bg-[#0ea5e9] rounded-full shadow-inner"></span>โลหะผสม</div><span className="font-['Fredoka_One'] text-lg">10%</span></div>
                                    <div className="h-[2px] bg-[#f0eeff] mx-2 rounded-full shadow-[inset_0_1px_1px_rgba(0,0,0,0.02)]"></div>

                                    <div className="flex justify-between items-center px-3 py-1.5 rounded-xl hover:bg-[#f0eeff] transition-colors"><div className="flex items-center gap-3"><span className="w-4 h-4 bg-[#94a3b8] rounded-full shadow-inner"></span>เหล็ก</div><span className="font-['Fredoka_One'] text-lg">5%</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            {/* 🌊 SVG Wave Divider 1 (เชื่อมสีม่วงอ่อน ไป มิ้นต์อ่อน) */}
            ...
            {/* ========================================= */}
            {/* SECTION 2: RECEIPTS (พื้นหลังสีมิ้นต์อ่อน) */}
            {/* ========================================= */}
            <div className="bg-[#ecfdf5] pt-10 pb-16">
                <div className="max-w-7xl mx-auto px-6 md:px-8 fade-up" style={{ animationDelay: '0.4s' }}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
                        <ReceiptBill category="PL" shopName="SchoolWaste" date="23/07/26" items={[{ name: "พลาสติกรวม", price: "5.00" }, { name: "ขวดน้ำขุ่น", price: "10.00" }, { name: "ขวดน้ำใส", price: "8.50" }, { name: "ขวดน้ำ PET สี", price: "4.00" }, { name: "LDPE (ถุงพลาสติกฯ)", price: "2.00" }]} />
                        ...
                        <ReceiptBill category="ETC" shopName="SchoolWaste" date="23/07/26" items={[{ name: "กระป๋องกาแฟ/นม", price: "5.00" }, { name: "เหล็กหนา", price: "1.00" }, { name: "เหล็กบาง", price: "5.50" }, { name: "สังกะสี", price: "5.50" }, { name: "กระป๋องเบียร์", price: "5.50" }]} />
                    </div>
                </div>
            </div>

            {/* 🌊 SVG Wave Divider 2 (เชื่อมสีมิ้นต์อ่อน ไป พีชอ่อน) */}
            ...
            {/* ========================================= */}
            {/* SECTION 3: DETAILED CHART (พื้นหลังสีพีชอ่อน) */}
            {/* ========================================= */}
            <div className="bg-[#fff7ed] pt-10 pb-24">
                <div className="max-w-7xl mx-auto px-6 md:px-8 fade-up" style={{ animationDelay: '0.6s' }}>
                    <div className="clay-card p-8 md:p-12 w-full bg-white">
                        <div className="flex flex-col items-center mb-10">
                        ...
                        <div className="flex flex-col gap-4">
                            {detailedWaste.map((item, index) => (
                                <div key={index} className="flex items-center gap-3 md:gap-5 hover:bg-[#fff7ed] p-3 rounded-2xl transition-colors cursor-default">
                                    <div className="w-1/3 md:w-1/4 text-right font-['Nunito'] font-bold text-sm md:text-base text-[#1e1b4b] truncate">
                                        {item.name}
                                    </div>
                                    <div className="flex-1 h-6 md:h-8 bg-[#f8f9fa] rounded-full overflow-hidden shadow-[inset_0_3px_8px_rgba(0,0,0,0.06)]">
                                        <div
